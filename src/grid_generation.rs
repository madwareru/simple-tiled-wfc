        ...
        for brush_id in 0..6 {
            ...
            for (j_dest, j_source) in v_zip.clone() {
                for (i_dest, i_source) in h_zip.clone() {
                    ...
                    if neighbours.north.is_some() && lookup[(j_source - 1) * 16 + i_source] == 1 {
                        println!("north");
                    ...
                    if neighbours.south.is_some() && lookup[(j_source + 1) * 16 + i_source] == 1 {
                        println!("south");
                    ...
                    if neighbours.east.is_some() && lookup[j_source * 16 + i_source + 1] == 1 {
                        println!("east");
                    ...
                    if neighbours.west.is_some() && lookup[j_source * 16 + i_source - 1] == 1 {
                        println!("west");
